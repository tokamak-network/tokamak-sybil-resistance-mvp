...
jq .abi out/Sybil.sol/Sybil.json > out/Sybil.sol/Sybil.abi

# Use abigen to generate a Go package from the ABI and binary, and save it in the abi folder
abigen --abi=out/Sybil.sol/Sybil.abi --bin=out/Sybil.sol/Sybil.bin --pkg=sybil --out=../sequencer/eth/contracts/sybil.go
